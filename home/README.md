...
## Steps
index.html
    1. Add Section 4 to content
    2. Link app.js file in index.html
app.js   
    1.Dynamically build the navbar using the existing section elements defined in the HTML file
    2.scrolls to anchors from navigation,
    3.highlights section in viewport upon scrolling.
style.css
    1. set display to flex and float to right on navbar__menu class 
    2. add menu__linkclicked class   
